...
<body style="background-color: #004528;">
	...
	<div class="form1">
		...
		<label><h4><b>Middle Name</b></h4></label>
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admin SET pic='$pic', fname='$fname',mname='$mname', lname='$lname', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";
