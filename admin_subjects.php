...
>	
	...
	<div class="srch" >
		...
		<a href="add.php"><button  style="background-color: #6db6b9e6; height: 30px; " >add new data</button ></a><br/><br/>
      ...
      if(isset($_SESSION['login_user'])) 
    {
        ...
        echo "<th>"; echo "ID of Subjects";  echo "</th>";
        ...
        echo "<td>";
          ?> <a href="upload.php?id=<?php echo $row["id"]; ?>"> <button type="button" class="btn btn-success">UPLOAD</button></a> <?php
          ?> <a href="admin_downloads.php?id=<?php echo $row["id"]; ?>"> <button type="button" class="btn btn-success" style="margin-left: 20px;">ENTER</button></a> <?php
        echo "</td>";
				echo "<td>";
     			?> <a href="editsubjects.php?id=<?php echo $row["id"]; ?>"> <button type="button" class="btn btn-success">update</button></a> <?php
     		echo "</td>";
     		echo "<td>";
     			?> <a href="deletesubjects.php?id= <?php echo $row["id"]; ?>"> <button type="button" class="btn btn-danger">delete</button> </a> <?php
     		echo "</td>";
